...
public class Eventos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        LDestino.setBackground(new java.awt.Color(255, 255, 255));
        LDestino.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
    ...
    private void BCopiarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BCopiarActionPerformed
        ...
        /*String T=TFTexto.getText();
        LDestino.setText(T);
        */
        LDestino.setText(TFTexto.getText());
    ...
    private void TFTextoKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TFTextoKeyReleased
        ...
        if (T.length()>=5)
            ...
            BCopiar.setEnabled(false);
        */
        BCopiar.setEnabled(TFTexto.getText().length()>=5);
